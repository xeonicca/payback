...
// Form with all fields — manual-only fields are optional so receipt mode passes validation
...
// Auto-focus amount input when switching to manual tab
watch(activeTab, (tab) => {
  if (tab === 'manual') {
    nextTick(() => {
    ...
    <ui-drawer-content>
      <div class="mx-auto w-full max-w-sm flex flex-col max-h-[85vh]">
        ...
        <div class="overflow-y-auto flex-1 px-4 py-2 space-y-4">
          ...
          <!-- Shared: payer and sharer selection -->
