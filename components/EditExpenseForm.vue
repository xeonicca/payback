  ...
  <ui-alert-dialog v-if="isDesktop" v-model:open="open">
    <ui-alert-dialog-content class="max-w-lg max-h-[85vh] flex flex-col p-0 gap-0">
      ...
      <ui-alert-dialog-footer class="px-6 py-4 border-t">
        ...
        <ui-button @click="onSubmit">儲存變更</ui-button>
      ...
      <div class="mx-auto w-full max-w-sm flex flex-col max-h-[85vh]">
        ...
        <div class="overflow-y-auto flex-1 px-4 py-4 space-y-4">
          ...
          <div class="flex items-start justify-between gap-2">
            <div class="flex-1 px-2">
              <ui-form-field v-slot="{ componentField }" type="radio" name="paidByMemberId">
                <ui-form-item>
                  <ui-form-label class="text-sm">選擇付款人</ui-form-label>
                  <ui-form-control>
            ...
            <div class="flex-1 px-2">
              <ui-form-item>
                <ui-form-field name="sharedWithMemberIds">
                  <ui-form-label class="text-sm">選擇平分的成員</ui-form-label>
                  <ui-form-field
                    v-for="member in tripMembers"
                    v-slot="{ value, handleChange }"
                    :key="member.id"
          ...
          <div class="space-y-4">
            ...
            <div v-else class="space-y-3">
              ...
              >
                <div class="flex items-center justify-between">
                  <h4 class="text-sm font-medium text-foreground m-0">項目 {{ index + 1 }}</h4>
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <ui-badge class="absolute right-2 top-1/2 transform -translate-y-1/2 px-2 py-1 text-xs">{{ selectedCurrency }}</ui-badge>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p class="text-xs text-muted-foreground mt-1 m-0">未選擇則由所有分攤成員共同分攤</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <ui-drawer-footer class="pb-safe">
          ...
          <ui-drawer-close as-child>
            <ui-button variant="outline">取消</ui-button>
          </ui-drawer-close>
        </ui-drawer-footer>
      </div>
    </ui-drawer-content>
